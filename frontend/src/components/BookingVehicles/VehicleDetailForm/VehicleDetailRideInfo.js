...
const VehicleDetailRideInfo = () => {
    ...
    return (
        <Box sx={{border: '1px dashed grey', padding: 2, marginBottom: 2}}>
            <Typography variant='h5' textAlign='center' marginBottom={3}>Ride Information</Typography>
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={6}>
                    Pickup
                        Time: {formatDateString(rideInfo.pickupDate)} {formatDateString(rideInfo.pickupTime, 'HH:mm')}
                </Grid>
                <Grid item xs={6}>
