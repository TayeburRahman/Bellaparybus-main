  ...
  return (
    ...
    >
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Item>
            <img width="100%" src={"https://picsum.photos/600/100"} alt="Banner" />
          </Item>
        </Grid>
        <Grid item md={6} xs={12}>
          <Item>
            <div
              style={{ fontSize: 40, textAlign: "left", fontWeight: "bold" }}
            >
              Contact US
            </div>
            <TextField
              ...
              error={formClicked && !validateValue(name, requiredValidators)}
              required
              variant="outlined"
            ...
            <TextareaAutosize
              ...
              style={{ width: "100%", margin: "10px 0 0 0", resize: "vertical", padding: 12 }}
            />
            <Button variant="contained" style={{ marginTop: 20 }} onClick={confirmForm}>
              Submit
            </Button>
          </Item>
        </Grid>
          ...
          <Item xs={12}>
            <div style={{ height: "300px", width: "100%" }}>
              <GoogleMapReact
                ...
                bootstrapURLKeys={{ key: "AIzaSyCVRTzzQ6QFpeM9D4svdq9U7KSAX0JUHSw" }}
